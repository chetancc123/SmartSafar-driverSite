...
CREATE TABLE `useridentity_roles` (
  ...
  PRIMARY KEY (`role_id`,`useridentity_id`),
  KEY `FKddwtdjp4ycy7fr10pu9aj8co7` (`useridentity_id`),
...
INSERT INTO `useridentity_roles` VALUES (4,1),(6,2),(1,3),(2,203),(1,252),(1,303),(1,304);
